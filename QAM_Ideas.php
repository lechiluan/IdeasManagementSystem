                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="bg-light p-3 text-center mb-3">
                                <a href="QAC_Topic_Detail.html" class="text-decoration-none text-dark">
                                    ...
                                    <p class="mb-1"><i class="fas fa-calendar-alt"></i> <strong>Deadline for submit:</strong> <span class="font-weight-bold">10:00 AM, 28 Mar 2023</span></p>
                                    <p><i class="fas fa-calendar-alt"></i> <strong>Final deadline:</strong> <span class="font-weight-bold">11:59 PM, 31 Mar 2023</span></p>
                                </a>
                            </div>
                            ...
                            <div class="bg-light p-3 text-center mb-3">
                                ...
                                <a href="#" class="btn btn-sm btn-primary mb-2"><i class="fas fa-file-archive"></i> Download all ideas (.zip)</a>
                                <a href="#" class="btn btn-sm btn-primary mb-2"><i class="fas fa-file-csv"></i> Export ideas (.csv)</a>
                            </div>

                        ...
                        <li class="dropdown-item p-1 rounded">
                            <a href="Staff_Last.php" class="d-flex align-items-center text-decoration-none text-dark"
                               id="manage-topics">
                                ...
                                <div>
                                    <p class="m-0" style="padding-left: 10px;" id="manage-topics-text">Last Ideas</p>
                                </div>
                            </a>
                        </li>
                ...
                <?php if (mysqli_num_rows($result) > 0) { ?>
                    <div class="d-flex flex-column justify-content-center w-100 mx-auto"
                            ...
                            <div class="bg-white p-4 rounded shadow mt-3">
                                ...
                                <div id="comment<?php echo $row['IdeaID']; ?>" class="collapse">
                                    ...
                                    if ($current_date > $closure_date && $current_date > $final_closure_date) {
                                        ...
                                        <!-- Comment form -->
                                        <div class="mt-3">
                                            <form action="Staff_Last.php" method="post">
                        ...
                        <div class="pagination">
                            ...
                            if ($page > 1) {
                                echo "<a href='Staff_Last.php?page=1' class='pagination-link'>&laquo; First</a>";
                                echo "<a href='Staff_Last.php?page=" . ($page - 1) . "' class='pagination-link'>&lsaquo; Previous</a>";
                            }
                            for ($i = max($first_page, $page - 3); $i <= min($last_page, $page + 3); $i++) {
                                ...
                                echo "<a href='Staff_Last.php?page=$i' class='$class' style='$style'>$i</a>";
                            }
                            if ($page < $total_pages) {
                                echo "<a href='Staff_Last.php?page=" . ($page + 1) . "' class='pagination-link'>Next &rsaquo;</a>";
                                echo "<a href='Staff_Last.php?page=$total_pages' class='pagination-link'>Last &raquo;</a>";
                            }
                            ?>
                        </div>
                    </div>
            ...
            if (isset($_POST['add-idea'])) {
                ...
                if (isset($_FILES['file-upload']['name']) && $_FILES['file-upload']['name'] != "") {
                    ...
                    if (!in_array($fileType, $validFileTypes)) {
                        ...
                        echo "<script>window.location.href = 'Staff_Last.php'</script>";
                        exit();
            ...
            <div class="modal fade" id="topic1Modal" tabindex="-1" aria-labelledby="topic1ModalLabel" aria-hidden="true"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <!-- body -->
                        <form action="Staff_Last.php" method="post" enctype="multipart/form-data">

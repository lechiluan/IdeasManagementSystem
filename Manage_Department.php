                    ...
                    <ul class="navbar-nav mt-4 ms-3 d-flex flex-column pb-5 mb-5" style="padding-top: 56px">
                        ...
                        <li class="dropdown-item p-1 rounded">
                            <a href="#" class="d-flex align-items-center text-decoration-none text-dark"
                                ...
                                <div>
                                    <p class="m-0" style="padding-left: 10px;" id="manage-topics-text">Manage Departments</p>
                                </div>
                            </a>
                        </li>
                ...
                <div class="d-flex flex-column justify-content-center mx-auto main-container">
                    ...
                    <div class="d-flex justify-content-end align-items-center my-4">
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createDepartmentModal">
                            <i class="fas fa-plus-circle"></i> Create Department</button>
                    </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form>
                                        <div class="mb-3">
                                            <label for="departmentName" class="form-label text-primary">Department Name:</label>
                    ...
                    <div class="bg-light p-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-outline-primary" data-bs-toggle="modal"
                                            data-bs-target="#editDepartmentModal"><i class="fas fa-edit"></i> Edit</button>
                                    </td>
                                </tr>
                                <tr>
                                    <td>2</td>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form>
                                    <div class="mb-3">
                                        <label for="editDepartmentName" class="form-label text-primary">Department Name:</label>

                ...
                <div class="d-flex flex-column justify-content-center mx-auto main-container">
                    ...
                    <form class="bg-light p-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <button class="btn btn-outline-primary mt-2" data-bs-toggle="modal"
                                        ...
                                        data-bs-title="Edit Deadline for Idea Submission"><i class="fas fa-edit"></i>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <button class="btn btn-outline-primary mt-2" data-bs-toggle="modal"
                                        ...
                                        data-bs-title="Edit Deadline to Close Comment"><i class="fas fa-edit"></i> Edit
                                        Deadline</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal fade" id="editDeadlineModal1" tabindex="-1"
                            aria-labelledby="editDeadlineModalLabel" aria-hidden="true" data-bs-backdrop="false">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header bg-primary text-white">
                                        ...
                                        <form>
                                            <div class="mb-3">
                                                <label for="newDeadlineTime" class="form-label text-primary">New
                                                    Deadline:</label>
                                                <input type="datetime-local" class="form-control" id="newDeadlineTime"
                                                    required>
                                            </div>
                                        </form>
                                    </div>

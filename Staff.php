                        ...
                        <div>
                            ...
                            <li class="my-2 p-1">
                                <a href="#" class="text-decoration-none text-dark d-flex align-items-center">
                                    <div class="d-flex align-items-center justify-content-center rounded-circle bg-gray p-1 me-3"
                                ...
                                <div class="comment-body">
                                    ...
                                    <div class="d-flex align-items-center mt-2">
                                        <div class="d-flex me-3">
                                            <button type="button" class="btn btn-outline-primary btn-sm me-2"><i
                                                    class="far fa-thumbs-up"></i> Like</button>
                                            <button type="button" class="btn btn-outline-danger btn-sm me-2"><i
                                                    class="far fa-thumbs-down"></i> Dislike</button>
                                            <button type="button" class="btn btn-outline-secondary btn-sm"
                                                data-bs-toggle="collapse" href="#replyComment1" aria-expanded="false"
                                                aria-controls="replyComment1"><i class="far fa-comment"></i>
                                                Reply</button>
                                        </div>
                                    </div>
                                    <!-- Reply form -->
                                        ...
                                        <form>
                                            ...
                                            <div class="form-floating mb-3" style="padding-top: 20px;">
                                                <textarea class="form-control" placeholder="Leave a reply here"
                                                    id="replyContent1" style="height: 100px"></textarea>
                            ...
                            <div class="d-none d-xxl-block h-100 fixed-top end-0 overflow-hidden scrollbar"
                                ...
                                <div class="p-3 mt-4">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#topic1Modal">Submit your ideas</button>
                                    <!-- deadline -->
                                ...
                                <div class="p-3 mt-4">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#topic2Modal">Submit your ideas</button>
                                    <!-- deadline -->
                                ...
                                <div class="p-3 mt-4">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#topic3Modal">Submit your ideas</button>
                                    <!-- deadline -->
                                            ...
                                            <div class="form-check mb-3">
                                                ...
                                                <label class="form-check-label" for="terms">
                                                    I agree to the <a href="#" data-bs-toggle="modal"
                                                        data-bs-target="#termsModal" class="text-primary">terms and
                                                        conditions</a>
                                                </label>
                                            </div>
                                        </div>

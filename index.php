                                ...
                                <form method="post" id="loginForm" autocomplete="off" novalidate="novalidate" action="">
                                    ...
                                    <div id="formsAuthenticationArea">
                                        <div id="userNameArea" style="display: block;">
                                            ...
                                            <input id="EmailInput" name="email" type="email" value="" tabindex="1" class="text fullWidth" spellcheck="false" placeholder="username@gre.ac.uk" autocomplete="off">
                                        </div>
                                        ...
                                        <div id="submissionArea" class="submitMargin">
                                            <button type="submit" id="submitButton" class="submit" tabindex="4" role="button">Sign in</button>
                                        </div>
                                    </div>
                                </form>
                                <div id="introduction" class="groupMargin">
                                    ...
                                    <table width="100%">
                                        <tbody>
                                            <tr>
                                                <th>
                                                    <div style="text-align:left; font-weight:normal"><a href="https://passwordreset.microsoftonline.com/?whr=gre.ac.uk">Forgotten my password</a>
                                                    </div>
                                                </th>
                                                <th>
                                                    <div style="text-align:right; font-weight:normal"><a href="https://www.gre.ac.uk/it-and-library/support">Need more help?</a>
                                                    </div>
                                                </th>
                                            </tr>
                                        </tbody>

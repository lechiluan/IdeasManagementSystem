                ...
                <div class="d-flex flex-column justify-content-center mx-auto main-container">
                    ...
                    <div class="d-flex justify-content-end align-items-center my-4">
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createAccountModal">
                            <i class="fas fa-plus-circle"></i> Create New Account</button>
                    </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form>
                                        ...
                                        <div class="mb-3">
                                            <label for="accountRole" class="form-label text-primary">Account
                                                Role:</label>
                                            <select class="form-select" id="accountRole" required>
                                                <option value="" disabled selected>Select Role</option>
                                                <option value="admin">QA Manager</option>
                                                <option value="user">QA coordinator</option>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><span class="badge bg-success rounded-pill">QA Coordinator</span></td>
                                    <td>Academi</td>
                                    <td>
                                        <button class="btn btn-outline-primary me-2" data-bs-toggle="modal"
                                            data-bs-target="#editAccountModal"><i class="fas fa-edit"></i> Edit</button>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-warning rounded-pill">Staff</span></td>
                                    <td>Support</td>
                                    <td>
                                        <button class="btn btn-outline-primary me-2" data-bs-toggle="modal"
                                            data-bs-target="#editAccountModal"><i class="fas fa-edit"></i> Edit</button>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-success rounded-pill">QA Manager</span></td>
                                    <td>Marketing</td>
                                    <td>
                                        <button class="btn btn-outline-primary me-2" data-bs-toggle="modal"
                                            data-bs-target="#editAccountModal"><i class="fas fa-edit"></i> Edit</button>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-danger rounded-pill">QA Manager</span></td>
                                    <td>IT</td>
                                    <td>
                                        <button class="btn btn-outline-primary me-2" data-bs-toggle="modal"
                                            data-bs-target="#editAccountModal"><i class="fas fa-edit"></i> Edit</button>
                                ...
                                <div class="modal-body">
                                    <form>
                                        ...
                                        <div class="mb-3">
                                            <label for="password" class="form-label text-primary">Password:</label>
                                            <div class="input-group">
                                                <input type="password" class="form-control" id="passwordEdit" required>
                                                <button class="btn btn-outline-secondary" type="button"
